                 ...
                 <form action="">
                     <div class="form-group floating-label-form-group controls">
                      ...
                      <div class="form-group floating-label-form-group controls">
                         ...
                         <input type="text" id="name" name="name" class="form-control" placeholder="Telefono/Celular" required="" data-validation-required-message="Ingresa tu nombre">
                         <p class="help-block text-danger"></p>
                     </div>
                     ...
                     <div class="form-group floating-label-form-group controls">
                         ...
                         <input type="password" id="password" name="password" class="form-control" placeholder="Confirmar Contraseña" required="" data-validation-required-message="Ingresa tu nombre">
                         <p class="help-block text-danger"></p>
                     </div>
            ...
            <div class="col-lg-8 col-md-10 mx-auto">
                 ...
                 <form action="">
                     <div class="form-group floating-label-form-group controls">
                         ...
                         <input type="text" id="user" name="user" class="form-control" placeholder="Correo o usuario" required="" data-validation-required-message="Ingresa usuario">
                         <p class="help-block text-danger"></p>
                     </div>

                     <div class="form-group floating-label-form-group controls">
                         <label for="">Contraseña</label>
                         <input type="password" id="password" name="password" class="form-control" placeholder="Contraseña" required="" data-validation-required-message="Ingresa usuario">
                         <p class="help-block text-danger"></p>
                     </div>
